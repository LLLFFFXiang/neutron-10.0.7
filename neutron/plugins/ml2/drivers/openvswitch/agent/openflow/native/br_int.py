...
"""
    ...
    （2）内层VLAN配置，函数有：
        ...
        reclaim_local_vlan
    （3）DVR相关配置，函数有：
        _dvr_to_src_mac_table_id
        install_dvr_to_src_mac
    （4）arp spoof protection(ARP反欺骗)相关配置，相关函数有：
        install_icmpv6_na_spoofing_protection
        install_arp_spoofing_protection
        delete_arp_spoofing_protection
        delete_arp_spoofing_allow_rules
"""
