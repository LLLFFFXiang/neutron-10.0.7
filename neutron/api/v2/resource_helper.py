...
def build_resource_info(plural_mappings, resource_map, which_service,
    ...
    # resource_map就是前面代码中的RESOURCE_ATTRIBUTE_MAP
    # 因此collection_name一共由两个值：'routers'、'floatingips'
    for collection_name in resource_map:
        # plural_mappings = {'router':'router', 'floatingips':'floatingip'}
        # 因此resource_name = 'router' or 'floatingip'
        # 就是资源的单数形式
        ...
        # member_actions在class L3的__init__函数中有定义
        ...
        controller = base.create_resource(
            ...
            allow_sorting=True)
        # 构建extensions.ResourceExtension对象实例
